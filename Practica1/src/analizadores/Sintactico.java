...
public class Sintactico extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\014\000\010\004\005\006\011\007\006\001\002\000" +
    "\010\002\ufffb\006\ufffb\007\ufffb\001\002\000\006\002\ufffd" +
    "\005\ufffd\001\002\000\010\002\ufff9\006\ufff9\007\ufff9\001" +
    "\002\000\004\002\016\001\002\000\006\002\000\005\014" +
    "\001\002\000\010\002\ufffa\006\ufffa\007\ufffa\001\002\000" +
    "\010\002\uffff\006\011\007\006\001\002\000\010\002\ufffc" +
    "\006\ufffc\007\ufffc\001\002\000\004\004\015\001\002\000" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\014\000\012\002\006\003\007\004\011\005\003\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Sintactico$act_num)
		...
		RESULT = start_val;
		 ...
		 System.out.print(p_inicial); 
          ...
          case 2: // S ::= B 
            {
              Object RESULT =null;
		 System.out.print("La cantidad de ceros es: "+ cCeros+" y " );
		...
		String c = (String)((java_cup.runtime.Symbol) CUP$Sintactico$stack.peek()).value;
		 System.out.print(c+","); 
              CUP$Sintactico$result = parser.getSymbolFactory().newSymbol("D",1, ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)), ((java_cup.runtime.Symbol)CUP$Sintactico$stack.peek()), RESULT);
            }
          return CUP$Sintactico$result;
          ...
          case 7: // NUM ::= cero 
            {
              Object RESULT =null;
		 cCeros += 1; 
              CUP$Sintactico$result = parser.getSymbolFactory().newSymbol("NUM",3, ((java_cup.runtime.Symbol)CUP$Sintactico$stack.peek()), ((java_cup.runtime.Symbol)CUP$Sintactico$stack.peek()), RESULT);
            }
          return CUP$Sintactico$result;
